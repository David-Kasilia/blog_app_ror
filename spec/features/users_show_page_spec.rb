...
RSpec.describe 'Users Show  page', type: :feature do
  describe 'User show Page' do
    before(:each) do
      ...
      @post1 = Post.create(author: @user2, title: 'My First Post', text: 'This is my first post',
                           comments_counter: 1, likes_counter: 2)
      @post2 = Post.create(author: @user3, title: 'My Second Post', text: 'This is my first post',
                           comments_counter: 2, likes_counter: 3)
      @post3 = Post.create(author: @user4, title: 'My Third Post', text: 'This is my first post',
                           comments_counter: 3, likes_counter: 4)
      @post4 = Post.create(author: @user5, title: 'My Fourth Post', text: 'This is my first post',
                           comments_counter: 4, likes_counter: 5)
      @post5 = Post.create(author: @user6, title: 'My Fifth Post', text: 'This is my first post',
                           comments_counter: 4, likes_counter: 6)
