...
RSpec.describe 'Posts Show  page', type: :feature do
  describe 'post index Page' do
    before(:each) do
      ...
      @post2 = Post.create(author: @user2, title: 'My second Post', text: 'This is my first post',
                           comments_counter: 2, likes_counter: 3)
      @post3 = Post.create(author: @user2, title: 'My third Post', text: 'This is my first post',
                           comments_counter: 3, likes_counter: 4)
      @post4 = Post.create(author: @user2, title: 'My fourth Post', text: 'This is my first post',
